...
pozoviApiServis("post", ApiReferenca::dajInstancu()->dajReferencu()."Web%20servisi/dobijListuProizvoda.php", $parameter);
    ...
    foreach ($jsonArray as $item) {
        ...
        foreach ($privilegije->dobijDozvole() as $dozvola)
            if ($dozvola == "brisanje_proizvoda") {
                echo "<td name='sakrivenaKolona' style=' text-align: center; background-color: transparent;'><a class='btn btn-warning' onclick='vratiProizvod(this.id);' href='#' id='" . $json['ID'] . "'>Vrati proizvod</a></td>";
            }
